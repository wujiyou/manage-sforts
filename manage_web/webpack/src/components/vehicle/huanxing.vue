<template>
  <div class="radial-indicator-container" :style="{'width':size+'px','height':size+'px'}">
    <div class="percentloop">
      <div class="circle-left" style="background-color:#59B8D4">
        <div style=" backgroundColor: #c4dfa7" ref="leftcontent"></div>
      </div>
      <div class="circle-right" style="background-color:#59B8D4">
        <div style=" backgroundColor: #c4dfa7" ref="rightcontent"></div>
      </div>
      <div class="content-wrap">
        <span class="content-number" :title="percent+'个'">{{percent}}个</span>
