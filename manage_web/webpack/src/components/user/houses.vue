  ...
  <div>
    ...
    <el-card class="box-card">
      ...
      <el-dialog
        ...
        append-to-body
      >
        <el-form @keyup.enter.native="newUserssure" :model="form" :rules="rulses">
          <!-- ref="form" -->
          ...
          <el-col :span="24">
            ...
            <el-col :span="8">
              <el-form-item label="负责人:" label-width="140px" prop="name">
                <el-input v-model="form.name" autocomplete="off"></el-input>
              </el-form-item>
            </el-col>
          </el-col>
          ...
          <el-col :span="24">
            ...
            <el-col :span="8">
              <el-form-item label="密码:" label-width="140px" prop="name">
                <el-input type="password" v-model="form.name" autocomplete="off"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="确认密码:" label-width="140px" prop="name">
                <el-input type="password" v-model="form.name" autocomplete="off"></el-input>
              </el-form-item>
            </el-col>
          </el-col>
          <el-col :span="24">
            <el-col :span="8">
                <el-form-item label="角色:" label-width="140px" prop="name">
                  <el-select
                    style=" width: 100%;"
                    @clear="loadUserList()"
                    value-key="usenames"
