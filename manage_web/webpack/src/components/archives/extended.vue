<template>
  <el-card class="box-card">
    ...
    <my-bread level1="站点从业人员管理" level2="充装站人员管理"></my-bread>
    <!--搜索  -->
    <el-row>
      <el-col :span="21">
        <el-input
    ...
    <template>
      <el-table height="474px" :data="userlist" style="width: 100%;margin:20px 5px">
        ...
        <el-table-column prop="username" label="所属单位" width="120"></el-table-column>
        <el-table-column prop="email" label="设备品种"></el-table-column>
        <el-table-column prop="mobile" label="产品编号"></el-table-column>
        <el-table-column prop="role_name" label="充装介质"></el-table-column>
        <el-table-column prop="mobile" label="制造单位"></el-table-column>
        <el-table-column prop="mobile" label="检验日期"></el-table-column>
        <el-table-column prop="id" label="下检日期" ></el-table-column>
         <el-table-column prop="mobile" label="状态"></el-table-column>
        <el-table-column prop="id" label="是否黑名单"></el-table-column>
  ...
  methods: {
    ...
    async getUserlist() {
      ...
      const res = await this.$http.get(
        `hai/public/warning/list?departmentId=1&currPage=${this.currPage}&pageSize=${this.pageSize}`
      );
      console.log(res);
