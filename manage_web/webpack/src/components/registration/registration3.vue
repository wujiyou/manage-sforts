<template>
  <div>
    <div style="background:white;width:99.1%;padding-left:15px">
      <my-bread level1="单位登记" level2="单位登记" level3="充装单位"></my-bread>
    </div>
    <el-card class="box-card" style="margin:20px 20px 0 20px;">
      ...
      <el-dialog
        ...
        append-to-body
      >
        <el-form :model="formerer" ref="formerer" :rules="rulesss">
          <el-col :span="24">
            <el-col :span="8">
              <el-form-item hidden prop="provinceCode" label-width="140px" label="行政省份:">
                <el-select
                  :disabled="showCmd"
                  v-model="formerer.provinceCode"
                  @change="function2(formerer.provinceCode)"
                  placeholder="请选择"
                >
                  <el-option
                    v-for="item in ProvinceId"
            ...
            <el-col :span="8">
              <el-form-item hidden prop="cityCode" label-width="140px" label="市级区域:">
                <el-select
                  :disabled="showCmd_1"
                  v-model="formerer.cityCode"
                  @change="function1(formerer.cityCode)"
                  placeholder="请选择"
                >
                  <el-option
                    v-for="item in CityId"
            ...
            <el-col :span="8">
              <el-form-item hidden prop="areaCode" label-width="140px" label="区级:">
                <el-select :disabled="showCmds" v-model="formerer.areaCode" placeholder="请选择">
                  <el-option
                    v-for="item in AreaId"
                    :key="item.id"
                    :label="item.name"
          ...
          <el-col :span="24">
            <el-col :span="11">
              <el-form-item label="姓名" label-width="150px" prop="name">
                <el-input v-model="formerer.name" autocomplete="off"></el-input>
              </el-form-item>
            </el-col>
            ...
            <el-col :span="11">
              <el-form-item label="账号" label-width="150px" prop="username">
                <el-input v-model="formerer.username" autocomplete="off"></el-input>
              </el-form-item>
            </el-col>
          </el-col>
          <el-col :span="24">
            <el-col :span="11">
              <el-form-item label="联系电话" label-width="150px">
                <el-input v-model="formerer.phone" autocomplete="off"></el-input>
              </el-form-item>
            </el-col>
            ...
            <el-col :span="11">
              <el-form-item label="身份证" label-width="150px">
                <el-input v-model="formerer.idCard" autocomplete="off"></el-input>
              </el-form-item>
            </el-col>
          </el-col>
          <el-col :span="24">
            <el-col :span="11">
              <el-form-item label="员工类型" label-width="150px" prop="type">
                <el-select disabled style="width: 100%" v-model="formerer.type">
                  <el-option
            ...
            <el-col :span="11">
              <el-form-item label="作业人员证号" label-width="150px" prop="workNumber">
                <el-input v-model="formerer.workNumber" autocomplete="off"></el-input>
              </el-form-item>

              <el-form-item hidden label="ID" label-width="150px" prop="unitId">
                <el-input v-model="formerer.unitId" autocomplete="off"></el-input>
              </el-form-item>
            </el-col>
          </el-col>
            ...
            <el-col :span="11">
              <el-form-item label="发证日期" label-width="150px" prop="certificateTime">
                <el-date-picker
                  type="date"
                  placeholder="选择日期"
                  v-model="formerer.certificateTime"
                  value-format="yyyy-MM-dd"
                  style="width: 100%;"
                ></el-date-picker>
              </el-form-item>
          ...
          <el-col :span="24">
            <el-col :span="11">
              <el-form-item hidden label="密码" label-width="150px">
                <el-input v-model="formerer.password" type="password" autocomplete="off"></el-input>
              </el-form-item>
            </el-col>
          </el-col>
        </el-form>
...
export default {
  ...
  watch: {
    ...
    dialogFormVisibleAdd: function (val, oldVla) {
      this.$refs["formerer"].resetFields();
    },
    dialogFormVisibleAdd: function (val, oldVla) {
  ...
  methods: {
    ...
    // 修改app用户确认发送请求
    async xiugaUserapp() {
      this.$refs.formerer.validate(async (valid) => {
        if (valid) {
          this.formerer.unitId = sessionStorage.getItem("unitIdss");
          this.formerer.provinceCode = this.provincecode;
          this.formerer.cityCode = this.citycode;
          this.formerer.areaCode = this.areacode;
          const res = await this.$http.put(`/app-user`, this.formerer);
          console.log(res);
          if (res.data.code === 0) {
            this.$message({
              type: "success",
