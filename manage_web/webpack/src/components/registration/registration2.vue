<template>
  <div>
    <div style="background:white;width:99.1%;padding-left:15px">
      <my-bread level1="单位登记" level2="单位登记" level3="制造单位"></my-bread>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      dialogFormVisibleAddapp: false,
      dialogFormVisibleAddsystem: false, //系统用户新增弹出框
      dialogFormfeiuser: false, //人员新增弹框
      changeVisibleAddapp: false, //修改app弹出框
      // dialogFormVisiblenewUserss:false,
  ...
  watch: {
    ...
    dialogFormVisibleAdd: function (val, oldVla) {
      this.$refs["rulseuser"].resetFields();
    },
  },
