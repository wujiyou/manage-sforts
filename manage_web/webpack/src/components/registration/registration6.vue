<template>
  <div>
    <div style="background:white;width:99.1%;padding-left:15px">
      <my-bread level1="单位登记" level2="单位登记" level3="配送单位"></my-bread>
    </div>
    <el-card class="box-card" style="margin:20px 20px 0 20px;">
      ...
      <el-dialog
        ...
        append-to-body
      >
        <el-form :model="former" ref="former" :rules="ruless">
          <el-col :span="24">
            <el-col :span="8">
              <el-form-item hidden prop="provinceCode" label-width="140px" label="行政省份:">
                <el-select
      ...
      >
        <el-form :model="former" ref="former" :rules="ruless">
          ...
          <el-col :span="24">
            ...
            <el-col :span="2"></el-col>
            <el-col :span="11">
              <el-form-item label="作业人员证号" class="red_s" label-width="150px" prop="workNumber">
                <el-input v-model="former.workNumber" autocomplete="off"></el-input>
              </el-form-item>
          ...
          <el-col :span="24">
            <el-col :span="11">
              <el-form-item label="发证日期" class="red_s" label-width="150px" prop="certificateTime">
                <el-date-picker
                  type="date"
                  placeholder="选择日期"
                  v-model="former.certificateTime"
            ...
            <el-col :span="2"></el-col>
            <el-col :span="11">
              <el-form-item label="换证日期" class="red_s" label-width="150px" prop="renewalTime">
                <el-date-picker
                  type="date"
                  placeholder="选择日期"
                  v-model="former.renewalTime"
...
export default {
  ...
  methods: {
    ...
    async getUserlist() {
      ...
      if (this.tyPe == 1) {
        const res = await this.$http.get(
          `/unit/findPage?rows=${this.rows}&page=${this.page}&type=5&unitName=${this.unitName}&licence=${this.licence}&provinceCode=${this.codes}&cityCode=${this.citys}&areaCode=${this.areas}`
        );
        console.log(res);
        this.userlist = res.data.data.list;
        this.total = res.data.data.totalCount;
        ...
        const res = await this.$http.get(
          `/unit/findPage?rows=${this.rows}&page=${this.page}&type=5&unitName=${this.unitName}&licence=${this.licence}&provinceCode=${this.codes}&cityCode=${this.citys}&areaCode=${this.areaCode}`
        );
        console.log(res);
        this.userlist = res.data.data.list;
        this.total = res.data.data.totalCount;
        ...
        const res = await this.$http.get(
          `/unit/findPage?rows=${this.rows}&page=${this.page}&type=5&unitName=${this.unitName}&licence=${this.licence}&provinceCode=${this.provinceCode}&cityCode=${this.cityCode}&areaCode=${this.areaCode}`
        );
        console.log(res);
        this.userlist = res.data.data.list;
        this.total = res.data.data.totalCount;
        ...
        const res = await this.$http.get(
          `/unit/findPage?rows=${this.rows}&page=${this.page}&type=5&unitName=${this.unitName}&licence=${this.licence}&provinceCode=${this.codes}&cityCode=${this.cityCode}&areaCode=${this.areaCode}`
        );
        console.log(res);
        this.userlist = res.data.data.list;
        this.total = res.data.data.totalCount;
