  ...
  <div class="container">
    ...
    <div class="appContainer" @click="hideMenu">
      <el-col :span="24" class="big_head">
        <div class="big_head_title">移动气瓶大数据</div>
        <div class="big_head_bottom_line"></div>
      </el-col>
      <el-col :span="24">
        <el-col :span="15">&nbsp;</el-col>
        <el-col :span="9">
          <el-col :span="4" style="color:white;text-align:right">气瓶状态:</el-col>
          <el-col :span="5">
        ...
        <div class="big_left_chart1_box">
          <el-col :span="24" class="info-main">
            ...
            <el-col :span="2" class="box1">
              ...
              <p class="span">充装站</p>
              <p class="span" id="listedCompany">{{this.cong}}</p>
            </el-col>
      ...
      <el-col :span="24">
        <div class="box">
          ...
          <div v-if="isMap" id="main" style="width:100%;height:100vh"></div>
        </div>
      </el-col>
    </div>
